...
public enum DefauldGUIType {
	...
	public Inventory generateAcceptGUI(GUI currentGUI, Consumer<Player> accept, String name, String displayName){
		...
		gui.getInventory().setItem(getItemPos(0), new ItemCreator("§aAccept", Material.WOOL,(short) 5).make());
		...
		gui.getInventory().setItem(getItemPos(1),new ItemCreator("§cDeny", Material.WOOL,(short) 14).make());
	...
	public Inventory generateGUI (Type type, String name, Map<Integer, ImmutablePair<ItemStack, Button>> items, Map<Integer, Displayer> displayers, String displayName) {
		...
		ItemStack item1=new ItemCreator("§1", Material.STAINED_GLASS_PANE, (short) 8).make();
		ItemStack item2=new ItemCreator("§1", Material.STAINED_GLASS_PANE, (short) 15).make();
